    ...
    return (
        <section className="bg-gray-50 py-12 px-4 md:px-8 flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-40">
                <a href="sakshyamshrestha111@gmail.com" className="flex items-center bg-white rounded-4xl shadow-md p-6 hover:shadow-xl transition-shadow duration-300 w-full md:w-1/4">
                    <FaEnvelope className="w-8 h-8 text-gray-700 mr-3" />
                    <span className="text-lg text-gray-800">E-mail</span>
                </a>
                <a href="https://www.linkedin.com/in/sakshyam-shrestha-8670112a3/" className="flex items-center bg-white rounded-4xl shadow-md p-6 hover:shadow-xl transition-shadow duration-300 w-full md:w-1/4">
                    <FaLinkedin className="w-8 h-8 text-gray-700 mr-3" />
                    <span className="text-lg text-gray-800">LinkedIn</span>
                </a>
                <a href="+977-9808002930" className="flex items-center bg-white rounded-4xl shadow-md p-6 hover:shadow-xl transition-shadow duration-300 w-full md:w-1/4">
                    <FaPhone className="w-8 h-8 text-gray-700 mr-3" />
                    <span className="text-lg text-gray-800">Phone</span>
                </a>
                <a href="https://github.com/Sakshyam11111" className="flex items-center bg-white rounded-4xl shadow-md p-6 hover:shadow-xl transition-shadow duration-300 w-full md:w-1/4">
