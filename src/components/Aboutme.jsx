...
const AboutMe = () => {
  ...
  return (
    <section id="about" className="container mx-auto py-12 px-4 md:px-8 flex flex-col md:flex-row items-center justify-center gap-8">
      {/* Left Side: Image */}
      ...
      <div className="w-full md:w-2/3 flex flex-col items-center">
        <div className="text-center mb-6" data-aos="fade-left">
        ...
        {/* Description */}
        <p className="mt-8 text-gray-700 text-center max-w-lg" data-aos="fade-up">
